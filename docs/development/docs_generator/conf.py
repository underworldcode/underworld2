...
latex_documents = [
    (master_doc, 'underworld.tex', u'underworld Documentation',
     u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'underworld', u'underworld Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'underworld', u'underworld Documentation',
     author, 'underworld', 'One line description of project.',
     'Miscellaneous'),
]
