...
for index in range(0,swarm.particleLocalCount):
...
# also create one to write particle counts
...
# first create local numpy copies in memory, as h5py has limitations 
# in the way you can index its arrays
