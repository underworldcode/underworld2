...
Lastest stable release (master branch) [![Build Status](http://128.250.120.154:8080/buildStatus/icon?job=master)](http://128.250.120.154:8080/buildStatus/icon?job=master)

Development branch - compile | [![Build Status](http://128.250.120.154:8080/buildStatus/icon?job=compile-dev)](http://128.250.120.154:8080/buildStatus/icon?job=compile-dev) unit tests | [![Build Status](http://128.250.120.154:8080/buildStatus/icon?job=test-dev)](http://128.250.120.154:8080/buildStatus/icon?job=test-dev)
