...
Value::Value(const Value& v) : mValueType(v.mValueType)
{
  switch (mValueType)
  {
    ...
    case IntVal       : mIntVal = v.mIntVal; mFloatVal = (float)v.mIntVal; mDoubleVal = (double)v.mIntVal; mBoolVal = (bool)v.mIntVal; break;
...
{
  if (mValueType != BoolVal && mValueType != IntVal)
